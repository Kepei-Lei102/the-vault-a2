...
- **Leads to:** **Half-Adder and Full-Adder** *(not yet released)* — the sum and carry outputs are Boolean functions you design and minimise with exactly this method; [[Flip-Flops]] — sequential design reduces each flip-flop's next-state logic with K-maps.
