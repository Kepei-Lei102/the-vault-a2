...
- **Foundation:** [[Number Bases]] — fixed-width binary and the byte; **Half-Adder and Full-Adder** *(not yet released)* — the full-adder's carry-out is literally the overflow signal.
