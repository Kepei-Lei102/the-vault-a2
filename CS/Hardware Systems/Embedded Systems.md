...
- **Kindred:** [[Von Neumann machine]] — the MCU is the smallest, cheapest, most numerous von Neumann machine ever built; **Clock Domains and Metastability** *(not yet released)* — what really happens at the GPIO pin when the asynchronous world meets the clocked chip.
